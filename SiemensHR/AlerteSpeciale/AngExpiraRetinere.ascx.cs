...
{
	/// <summary>
	///		Summary description for AngExpiraRetinere.
	/// </summary>
	public class AngExpiraRetinere: System.Web.UI.UserControl
	{
		#region Variabile
		protected System.Web.UI.WebControls.Table ResultTable;
		private int Ind;
		protected System.Web.UI.WebControls.Table tableRetineriHeader;
		protected System.Web.UI.WebControls.DataGrid listDataGridAngajati;
		...
		{
			this.listDataGridAngajati.ItemCreated += new System.Web.UI.WebControls.DataGridItemEventHandler(this.listDataGrid_ItemCreated);
			this.listDataGridAngajati.PageIndexChanged += new System.Web.UI.WebControls.DataGridPageChangedEventHandler(this.listDataGrid_PageIndexChanged);
			this.listDataGridAngajati.SortCommand += new System.Web.UI.WebControls.DataGridSortCommandEventHandler(this.listDataGrid_SortCommand);
			this.listDataGridAngajati.ItemDataBound += new System.Web.UI.WebControls.DataGridItemEventHandler(this.listDataGrid_ItemDataBound);
			this.listDataGridAngajati.Load += new System.EventHandler(this.listDataGrid_Load);
			this.listDataGridAngajati.SelectedIndexChanged += new System.EventHandler(this.listDataGridAngajati_SelectedIndexChanged);
		...
		void listDataGrid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			if (e.Item.ItemIndex!=-1)  // daca e header nu pune evenimentele
			{
				...
				e.Item.Attributes.Add("onclick", "EditRetinereAngajatAlerta(this)");
		...
		private void listDataGrid_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
		{
			...
			DataSet dt2 = (DataSet)Session["DataSource_Retineri"];
			...
			listDataGridAngajati.DataSource = dv2;
			Ind = (listDataGridAngajati.CurrentPageIndex * listDataGridAngajati.PageSize) + 1;
			listDataGridAngajati.DataBind();
		}
		#endregion

		#region RefreshTableRetineri
		/// <summary>
		/// Procedura actualizeaza datele in tabel
		/// </summary>
		private void RefreshTableRetineri()
		{
			DataSet dt2 = (DataSet)Session["DataSource_Retineri"];
			DataView dv2 = dt2.Tables[0].DefaultView;
			listDataGridAngajati.DataSource = dv2;
			...
			{
				listDataGridAngajati.Visible = false;
				CreateResultTable(ResultTable, "Nu exista nici un angajat caruia sa ii expire retinerile", "", "normal");
			}
			else
			{
				listDataGridAngajati.Visible = true;
			}
		}
		#endregion
		...
		{
			listDataGridAngajati.CurrentPageIndex = e.NewPageIndex;
			RefreshTableRetineri();	
		}
		#endregion

		private void listDataGridAngajati_SelectedIndexChanged(object sender, System.EventArgs e)
		{
