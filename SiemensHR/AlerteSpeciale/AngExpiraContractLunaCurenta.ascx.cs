...
{
	/// <summary>
	///		Summary description for AngExpiraContractLunaCurenta.
	/// </summary>
	public class AngExpiraContractLunaCurenta : System.Web.UI.UserControl
	{
		#region Variabile
		...
		private void listDataGrid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			if (e.Item.ItemIndex!=-1)  // daca e header nu pune evenimentele
			{
				...
				e.Item.Attributes.Add("onclick", "EditAngajatContract(this)");
		...
		private void RefreshTableContract()
		{
			...
			if( dt.Tables[ 0 ].Rows.Count == 0 )
			{
				...
				CreateResultTable(ResultTable, "Nu exista nici un angajat caruia sa ii expire contractul de munca in luna activa", "", "normal");
			}
			else
			{
