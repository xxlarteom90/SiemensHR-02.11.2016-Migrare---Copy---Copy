...
{
	/// <summary>
	///		Summary description for AngExpiraPermisMunca.
	/// </summary>
	public class AngExpiraPermisMunca: System.Web.UI.UserControl
	{
		#region Variabile
		protected System.Web.UI.WebControls.DataGrid listDataGrid4;
		protected System.Web.UI.WebControls.Table tablePermisMuncaHeader;
		...
		{
			this.listDataGrid4.ItemCreated += new System.Web.UI.WebControls.DataGridItemEventHandler(this.listDataGrid_ItemCreated);
			this.listDataGrid4.PageIndexChanged += new System.Web.UI.WebControls.DataGridPageChangedEventHandler(this.listDataGrid_PageIndexChanged);
			this.listDataGrid4.SortCommand += new System.Web.UI.WebControls.DataGridSortCommandEventHandler(this.listDataGrid_SortCommand);
			this.listDataGrid4.ItemDataBound += new System.Web.UI.WebControls.DataGridItemEventHandler(this.listDataGrid_ItemDataBound);
			this.listDataGrid4.Load += new System.EventHandler(this.listDataGrid_Load);
		...
		void listDataGrid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			if (e.Item.ItemIndex!=-1)  // daca e header nu pune evenimentele
			{
				...
				e.Item.Attributes.Add("onclick", "EditAngajatAlertaPermisMunca(this)");
		...
		private void listDataGrid_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
		{
			...
			DataSet dt4 = (DataSet)Session["DataSource_PermisMunca"];

			// Create a DataView from the DataTable.
			DataView dv4 = dt4.Tables[0].DefaultView;

			// The DataView provides an easy way to sort. Simply set the
			// Sort property with the name of the field to sort by.
			dv4.Sort = e.SortExpression;
			Session["SortBy3"] = e.SortExpression;
			// RebIndexM the data source 
			listDataGrid4.DataSource = dv4;
			IndexM = (listDataGrid4.CurrentPageIndex * listDataGrid4.PageSize) + 1;
			listDataGrid4.DataBind();
		}
		#endregion
		...
		/// </summary>
		private void RefreshTablePermisMunca()
		{
			DataSet dt4 = (DataSet)Session["DataSource_PermisMunca"];
			DataView dv4 = dt4.Tables[0].DefaultView;
			listDataGrid4.DataSource = dv4;
			...
			{
				listDataGrid4.Visible = false;
				CreateResultTable(ResultTable, "Nu exista nici un angajat caruia sa ii expire permisul de munca", "", "normal");
			}
			else
			{
				listDataGrid4.Visible = true;
			}
		}
		#endregion
		...
		{
			listDataGrid4.CurrentPageIndex = e.NewPageIndex;
			RefreshTablePermisMunca();
		}
		#endregion
	}
