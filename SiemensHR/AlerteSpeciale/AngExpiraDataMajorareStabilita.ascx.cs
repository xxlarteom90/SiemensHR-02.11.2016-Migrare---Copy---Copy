...
{
	/// <summary>
	///		Summary description for AngExpiraDataMajorareStabilita.
	/// </summary>
	public class AngExpiraDataMajorareStabilita : System.Web.UI.UserControl
	{
		#region Variabile
		...
		private void listDataGrid_ItemDataBound(object sender, System.Web.UI.WebControls.DataGridItemEventArgs e)
		{
			...
			if (e.Item.ItemIndex!=-1)  // daca e header nu pune evenimentele
			{
				...
				e.Item.Attributes.Add("onclick", "EditAngajatAlertaMajorare(this)");
		...
		private void listDataGrid_SortCommand(object source, System.Web.UI.WebControls.DataGridSortCommandEventArgs e)
		{
			...
			DataSet dt = (DataSet)Session["DataSource_Majorare"];
		...
		private void RefreshTableContract()
		{
			...
			if( dt.Tables[ 0 ].Rows.Count == 0 )
			{
				...
				CreateResultTable(ResultTable, "Nu exista nici un angajat caruia sa i se apropie ziua de negociere a maririi de salariu!", "", "normal");
			}
			else
			{
