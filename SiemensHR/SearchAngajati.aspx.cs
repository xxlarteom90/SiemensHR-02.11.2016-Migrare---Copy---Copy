...
* Data:			17.09.2010
* Descriete:	Am adaugat la cautare avansata punctul de lucru.
*/
...
{
	/// <summary>
	/// Summary description for SearchAngajati.
	/// </summary>
	public class SearchAngajati : System.Web.UI.Page
	{
		#region Variabile
		...
		protected System.Web.UI.WebControls.TextBox txtNationalitateSearch;
		...
		protected System.Web.UI.WebControls.Button btnAddAngajat;
		...
		protected System.Web.UI.WebControls.RadioButton rbDataFixaSearch;
		protected System.Web.UI.WebControls.RadioButton rbLunaSearch;
		protected System.Web.UI.WebControls.RadioButton rbIntervalSearch;
		protected System.Web.UI.WebControls.RadioButton rbToateContracteleSearch;
		...
		protected System.Web.UI.WebControls.DropDownList lstAngajatLichidatSearch;
		protected System.Web.UI.WebControls.DropDownList lstPunctLucruSearch;
		...
		/// <summary>
		/// Procedura creaza variabilele JavaScript
		/// </summary>
		...
		/// <summary>
		/// Procedura obtine sirul de categorii salariale
		/// </summary>
		/// <returns>Returneaza un string care contine aceste categorii</returns>
		...
		/// <summary>
		/// Proneste cautarea rapida
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void btnFastSearch_Click(object sender, System.EventArgs e)
		{
			Response.Redirect("SearchAngajatiList.aspx");		
		}
		#endregion

		#region btnAddAngajat_Click
		/// <summary>
		/// Utilizatorul este redirectat catre pagina pentru adaugarea unui angajat
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		private void btnAdvancedSearch_Click(object sender, System.EventArgs e)
		{
			...
			Session["lstPunctLucruSearch"] = lstPunctLucruSearch.SelectedValue;
			...
			Session["lstPerioadaDeterminataSearch"] = lstPerioadaDeterminataSearch.SelectedValue;

			//Angajat lichidat
			Session["lstAngajatLichidatSearch"] = lstAngajatLichidatSearch.SelectedValue;
