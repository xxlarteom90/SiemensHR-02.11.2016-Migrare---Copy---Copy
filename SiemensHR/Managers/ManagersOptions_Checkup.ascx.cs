 ...
 *	Autor:		Ciobanu Alex 
 *  Data:		17.8.2005
 *	Denumire:	ManagersOptions_Checkup.ascx.cs
 *	Descriere:	Controlul permite utilizatorului sa selecteze datele de inceput si de sfarsit ale perioadei 
 *				de timp pe care doreste sa fie afisat raportul pentru datele de checkup ale angajatilor si 
...
{
	/// <summary>
	///		Summary description for ManagersOptions_CU.
	/// </summary>
	public class ManagersOptions_Checkup : System.Web.UI.UserControl
	{
		#region Variabile
		...
		{
			MO_CheckupRaport myMOCR = (MO_CheckupRaport) LoadControl("MO_CheckupRaport.ascx");
			myMOCR.DataStart=Parameters.MKConv(txtDataStart.Text);
			myMOCR.DataStop=Parameters.MKConv(txtDataStop.Text);
			PlaceHolder1.Controls.Clear();
			PlaceHolder1.Controls.Add(myMOCR);
		}
		#endregion
	}
}
