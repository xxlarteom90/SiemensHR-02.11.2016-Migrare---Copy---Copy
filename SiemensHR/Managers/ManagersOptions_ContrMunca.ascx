<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ManagersOptions_ContrMunca.ascx.cs" Inherits="SiemensHR.ManagersOptions_ContrMunca" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
	...
	<TABLE id="Table1" height="100%" cellSpacing="0" cellPadding="0" width="100%" border="0">
		...
		<tr style="FONT-WEIGHT: bold; TEXT-TRANSFORM: none; COLOR: #20b2aa; FONT-FAMILY: Arial">
			<td align="center" colspan="3" height="35">
				Contracte de munca din departamentul &nbsp;
		...
		<TR>
			<TD style="HEIGHT: 10px" align="left">
				<asp:RequiredFieldValidator id="RequiredFieldValidator1" runat="server" CssClass="AlertRedBold" ErrorMessage="Data de start nu a fost introdusa"
					ControlToValidate="txtDataStart"></asp:RequiredFieldValidator></TD>
			<td>
				<asp:RequiredFieldValidator id="RequiredFieldValidator2" runat="server" CssClass="AlertRedBold" ErrorMessage="Data de stop nu a fost introdusa"
