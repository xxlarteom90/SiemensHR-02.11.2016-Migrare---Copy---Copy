    ...
    public class rapoarte_DeclaratieUnica : SiemensHR.InterfataSalarii.Classes.BaseModule
    {
        ...
        private void btnGenereaza_Click(object sender, System.EventArgs e)
        {
            ...
            foreach (DataRow dr in dsVarGlobale.Tables[0].Rows)
            {
                ...
                //Artiom Modificat
                if (dr["Cod"].ToString().Equals("CIsom"))
                    CIsom = Convert.ToDouble(dr["Valoare"].ToString());
                ...
                // Adaugat Artiom
                if (dr["Cod"].ToString().Equals("SMBEANT"))
                    smbeant = Convert.ToDouble(dr["Valoare"].ToString());
                if (dr["Cod"].ToString().Equals("PcastigMed"))
                ...
                */
                ...
                if ((nrZileCBSoc + nrZileCBCas == 0) && (!(bool)dr["RetinereSomaj"] && !(bool)dr["RetinereSanatate"] && !(bool)dr["RetinereCAS"]))
                {
                    ...
                    else
                    {
                        ...
                        //Modificat Artiom data de 25.02.2018
                ...
                else
                {
                    ...
                    nodeAsiguratB3.Attributes["B3_11"].Value = ((int)(b3_9 + b3_10)).ToString();
                    double B3_12 = Math.Round(sumaCBFirma);
                    double B3_13 = Math.Round(ROUNDUP(sumaCBCas));
                    // Modificat Artiom
                    nodeAsiguratB3.Attributes["B3_12"].Value = B3_12 + "";
                    nodeAsiguratB3.Attributes["B3_13"].Value = B3_13 + "";
                    ...
                    List<string> d12_codes = new List<string>();
                    ...
                    foreach (DataRow drConcMedical in dsConcediiMedicale.Tables[0].Rows)
                    {
                        ...
                        if (id.Equals(idAng))
                        {
                            ...
                            //double d_17 = Double.Parse(nodeConcMedical.Attributes["D_17"].Value);
                            //double d_18 = Double.Parse(nodeConcMedical.Attributes["D_18"].Value);
                            //Before a fost ceea ce e mai jos Artiom Modificat
                         
                            nodeConcMedical.Attributes["D_19"].Value = ((string)(Math.Round(mediaZilnica, 2) + "")).Replace(",", ".");
                            // After pe data de 20.03.2019 am Modificat D_19 = D_17/D_18
                            //double d_19 = Double.Parse(nodeConcMedical.Attributes["D_19"].Value);
                            //      d_19 = d_17 / d_18;
                            ...
                            {
                                nodeConcMedical.Attributes["D_23"].Value = d9;
                            }
                ...
                if (datCAM == 1)
                {
                    if (sectiunea == "A")
                    {
                        c4_baza = c4_baza + Convert.ToDouble(nodeAsiguratA.Attributes["A_5"].Value.ToString());
                    }
                    else
                    {
                        c4_baza = c4_baza + Convert.ToDouble(nodeAsiguratB4.Attributes["B4_14"].Value.ToString());
                    }
                }
