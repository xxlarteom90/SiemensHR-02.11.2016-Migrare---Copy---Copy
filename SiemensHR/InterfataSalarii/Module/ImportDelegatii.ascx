<%@ Control Language="c#" AutoEventWireup="false" Codebehind="ImportDelegatii.ascx.cs" Inherits="SiemensHR.InterfataSalarii.Module.ImportDelegatii" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script language="javascript" src="../js/jsCode.js"></script>
<script>
function ImportClick()
{
	ImportDelegatiiClick();
}
...
function OnLoad()
{
	...
	document.getElementById(tdTemp).innerHTML = "<a target=_blank href='Templates\\TemplateDelegatii.xls'>template delegatii</a>";
	...
	<TR>
		<TD id="tablePontaj" vAlign="top" align="center" runat="server">
			<TABLE class="tabBackground" id="Table1" height="48" cellSpacing="0" cellPadding="0" width="100%"
				...
				<TR>
					<TD class="HeaderGreenBold" id="tdTitlu" align="center" colSpan="2">Import 
						delegatii</TD>
				</TR>
				<TR>
				...
				<TR>
					<TD class="NormalGreenBold" style="WIDTH: 128px" height="10"></TD>
					<TD class="NormalGreenBold" height="10"></TD>
				</TR>
				<TR>
					<TD class="NormalGreenBold" style="WIDTH: 128px" width="128">&nbsp;&nbsp;Fisier</TD>
				...
				<TR>
					<TD class="NormalGreenBold" style="WIDTH: 128px" vAlign="middle" width="128">&nbsp; 
						Template</TD>
					<TD class="NormalGreenBold" id="tdTemplate" runat="server"></TD>
				</TR>
				<TR>
					<TD class="NormalGreenBold" style="WIDTH: 128px" width="128" height="10"></TD>
					<TD class="NormalGreenBold" height="10"></TD>
				</TR>
				<TR>
					<TD class="NormalGreenBold" style="WIDTH: 128px" width="128" height="10"></TD>
					<TD class="NormalGreenBold" height="10">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<INPUT class="ButtonStyle" id="ButtonImport" onmouseover="MouseOverButton(this)" style="WIDTH: 248px"
							onclick="ImportClick()" onmouseout="MouseOutButton(this)" type="button" value="Import delegatii" name="ButtonImport" runat="server"></TD>
				</TR>
