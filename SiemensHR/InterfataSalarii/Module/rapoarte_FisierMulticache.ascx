<%@ Control Language="c#" AutoEventWireup="false" Codebehind="rapoarte_FisierMulticache.ascx.cs" Inherits="SiemensHR.InterfataSalarii.Module.rapoarte_FisierMulticache" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<table id="main" height="100%" width="100%">
	...
	<TR height="74%" width="100%">
		<TD vAlign="top" colSpan="2"><cc1:reportviewer id="raportFisierMulticache" runat="server" Width="100%" Height="400px" 
				BackColor="White" BorderColor="Transparent" Parameters="False" Toolbar="True" ForeColor="White" Zoom="100%" ReportPath="/Rapoarte/salarii"></cc1:reportviewer></TD>
	</TR>
</table>
