...
namespace SiemensHR.InterfataSalarii.Module
{
	...
	/// </summary>
	public class rapoarte_CursuriAngajatiPortal : SiemensHR.InterfataSalarii.Classes.BaseModule
	{
		...
		protected override void OnPreRender(EventArgs e)
		{
			...
			this.raportCursuriAngajati.SetQueryParameter("AngajatorID",this.GetAngajator().ToString());
