	...
	public class Calendar : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			if (!IsPostBack)
			{
				...
				int anEnd = DateTime.Now.Year + 10;
				ListItem myItem;
				for(int j=anStart; j<=anEnd; j++)
				{
					myItem = new ListItem(j.ToString(), j.ToString());
					if (j==Calendar1.SelectedDate.Year)
						myItem.Selected = true;
					lstYear.Items.Add(myItem);
				}
				lstMonth.SelectedValue = Calendar1.SelectedDate.Month.ToString();	
			}
		}
		#endregion
		...
		#region Calendar1_SelectionChanged
		/// <summary>
		/// Se retine noua data daca a fost modificata
		/// </summary>
		...
		#region Calendar1_VisibleMonthChanged
		/// <summary>
		/// Se retine noua luna aleasa
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		#region lstMonth_SelectedIndexChanged
		/// <summary>
		/// Se retine noua luna aleasa
		/// </summary>
		/// <param name="sender"></param>
		...
		#region lstYear_SelectedIndexChanged
		/// <summary>
		/// Se retine noul an ales
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
