<%@ Page language="c#" Codebehind="Calendar.aspx.cs" AutoEventWireup="false" Inherits="SiemensTM.utils.Calendar" %>
...
<asp:ListItem Value="12">Decembrie</asp:ListItem>
    ...
    <td><asp:dropdownlist onChange="Form1.submit()" id=lstYear runat="server"></asp:dropdownlist></td></tr>
  <tr>
    <td colSpan=4><asp:calendar id=Calendar1 runat="server" NextPrevFormat="ShortMonth">
<DayStyle Font-Size="Smaller" Font-Names="Arial" BorderWidth="1px" BorderStyle="Solid" BackColor="White">
</DayStyle>

<NextPrevStyle Font-Size="Smaller" Font-Names="Arial" Font-Bold="True" ForeColor="White">
</NextPrevStyle>

<DayHeaderStyle Font-Size="Smaller" Font-Names="Arial" Font-Bold="True" BorderWidth="1px" ForeColor="White" BorderStyle="Solid" BackColor="LightSeaGreen">
</DayHeaderStyle>

<SelectedDayStyle BackColor="Silver">
</SelectedDayStyle>

<TitleStyle Font-Names="Arial" Font-Bold="True" ForeColor="White" BackColor="#7B8FC2">
</TitleStyle>

<WeekendDayStyle Font-Size="Smaller" Font-Names="Arial" BackColor="#E0E0E0">
</WeekendDayStyle>
</asp:calendar></td></tr></table></form>
