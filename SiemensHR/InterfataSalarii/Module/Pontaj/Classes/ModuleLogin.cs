...
namespace SiemensTM.Classes
{
	...
	/// </summary>
	public class ModuleLogin : System.Web.UI.UserControl
	{
		#region Constructor
		/// <summary>
		/// Constructor
		...
		#region GetAngajat
		/// <summary>
		/// Procedura determina angajatul curent
		/// </summary>
		/// <returns>Returneaza id-ul angajatului curent</returns>
		public int GetAngajat()
		{
			return int.Parse( this.GetSessionKey( SiemensHR.InterfataSalarii.Classes.Definitions.AngajatKey ).ToString());
		}
		#endregion

		#region SetAngajat
		/// <summary>
		/// Procedura seteaza angajatului curent
		/// </summary>
		/// <param name="AngajatID">Id-ul angajatului</param>
		public void SetAngajat(long AngajatID)
		{
			this.SaveSessionKey( SiemensHR.InterfataSalarii.Classes.Definitions.AngajatKey,AngajatID );
		}
		#endregion
