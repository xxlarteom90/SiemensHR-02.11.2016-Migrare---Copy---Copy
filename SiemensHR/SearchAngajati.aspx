...
<%@ Page language="c#" Codebehind="SearchAngajati.aspx.cs" AutoEventWireup="false" Inherits="SiemensHR.SearchAngajati" %>
	...
	<body>
		...
		function CautareAvansata_Click()
		{
			if( tableCautareAvansataVisible.style.display=="none" )
			{
				...
				//document.getElementById( "btnCautareAvansata" ).value = "Dezactiveaza cautare avansata";
		...
		<form id="Form1" name="form_search" action="" runat="server">
				...
				<tr>
					<td align="center">
						<table cellSpacing="0" cellPadding="0" width="450" border="0">
													...
													<tr>
														<td class="tabBackgroundColor" align="center" colSpan="2">
															<table cellSpacing="0" cellPadding="0" width="100%">
																...
																<TR>
																	<TD class="NormalGreenBold" width="18%" height="25">Titlu:</TD>
																	<TD><asp:dropdownlist id="lstTitulaturaSearch" runat="server" CssClass="SelectStyle" Width="250px"></asp:dropdownlist></TD>
																</TR>
																<tr>
																	<td class="GreenSeparator" colSpan="2"><IMG height="1" src="images/1x1.gif"></td>
																</tr>
																...
																<!--<TR>
																	<TD class="NormalGreenBold" width="18%" height="25">Centru de cost:</TD>
																	<TD><asp:dropdownlist id="lstCentruCostSearch" runat="server" CssClass="SelectStyle" Width="250px"></asp:dropdownlist></TD>
																</TR>
																<tr>
																	<td class="GreenSeparator" colSpan="2"><IMG height="1" src="images/1x1.gif"></td>
																</tr>-->
																...
																<TR>
																	<TD class="NormalGreenBold" style="HEIGHT: 30px" width="18%" height="30">Punct de 
																		lucru:</TD>
																	<TD style="HEIGHT: 30px">
																		<asp:dropdownlist id="lstPunctLucruSearch" runat="server" CssClass="SelectStyle" Width="250px"></asp:dropdownlist></TD>
																</TR>
																<tr>
																	<td class="GreenSeparator" colSpan="2"><IMG height="1" src="images/1x1.gif"></td>
																</tr>
																...
																<TR>
																	<TD class="NormalGreenBold" width="18%" height="25">Deducere:</TD>
																	<TD class="NormalGreenBold"><asp:dropdownlist id="lstDeducereSearch" runat="server" CssClass="SelectStyle" Width="50px" onchange="lstDeducereSearchChanged();">
																			<asp:ListItem Value="-1">&#160;</asp:ListItem>
																			<asp:ListItem Value="1">Da</asp:ListItem>
																			<asp:ListItem Value="0">Nu</asp:ListItem>
																...
																<TR>
																	<TD class="NormalGreenBold" width="18%" height="25">Contract pe perioada 
																		determinata:</TD>
																	<TD>
																		<P><asp:dropdownlist id="lstPerioadaDeterminataSearch" runat="server" CssClass="SelectStyle" Width="50px">
																				<asp:ListItem Value="-1">&#160;</asp:ListItem>
																				<asp:ListItem Value="1">Da</asp:ListItem>
																				<asp:ListItem Value="0">Nu</asp:ListItem>
																			</asp:dropdownlist></P>
																...
																<TR>
																	<TD class="NormalGreenBold" width="18%" height="25">Lichidat</TD>
																	<TD>
																		<asp:dropdownlist id="lstAngajatLichidatSearch" runat="server" CssClass="SelectStyle" Width="50px">
																			<asp:ListItem Value="-1">&#160;</asp:ListItem>
																			<asp:ListItem Value="1">Da</asp:ListItem>
																			<asp:ListItem Value="0">Nu</asp:ListItem>
																		</asp:dropdownlist></TD>
							...
							<TR>
								<TD class="CommentRedBold" vAlign="top" align="left" colSpan="2" height="20">* 
									Cautarea se va face si dupa numele anterior</TD>
							</TR>
							<TR>
							...
							<tr>
								<td colSpan="2">
									<table cellSpacing="0" cellPadding="0" width="100%" border="0">
										<tr>
											<td class="UnderlineBlackBold">Pentru adaugarea unui angajat nou apasati pe acest 
												buton:
											</td>
											<td><asp:button id="btnAddAngajat" onmouseover="MouseOverButton(this)" onmouseout="MouseOutButton(this)"
													runat="server" CssClass="ButtonStyle" Text="Angajat nou"></asp:button></td>
										</tr>
									</table>
								</td>
							</tr>
			...
			<input id="txtTipCautareHidden" type="hidden" runat="server">
		</form>
	</body>
</HTML>
