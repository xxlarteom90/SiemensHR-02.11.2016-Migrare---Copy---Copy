<%@ Page language="c#" Codebehind="EditAngajat_Recrutori.aspx.cs" AutoEventWireup="false" Inherits="SiemensHR.EditAngajat_Recrutori" %>
	...
	<body>
		<form id="Form1" method="post" encType="multipart/form-data" runat="server">
			<table height="100%" cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				<tr>
					<td height="80"><uc1:pageheader id="PageHeader1" runat="server" relativepath="../"></uc1:pageheader></td>
				</tr>
				<tr>
