...
{
	/// <summary>
	/// Summary description for SearchAngajatiList_Recrutori.
	/// </summary>
	public class SearchAngajatiList_Recrutori : System.Web.UI.Page
	{
		#region Variabile
		...
		/// <summary>
		/// Procedura sterge variabilele de sesiune
		/// </summary>
		...
		/// <summary>
		/// Creaza o inregistrare in lista cu angajati
		/// </summary>
		...
		/// <summary>
		/// Permite sortarea angajatilor pe coloane
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		/// <summary>
		/// Afiseaza angajatii urmatori la trecerea la alta pagina in lista
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		...
		/// <summary>
		/// Creaza o inregistrare in tabelul cu angajati
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
