<%@ Page language="c#" Codebehind="SearchAngajatiList_Recrutori.aspx.cs" AutoEventWireup="false" Inherits="SiemensHR.SearchAngajatiList_Recrutori" %>
...
<HTML>
	...
	function EditAngajat(obj)
	{
       // Artiom Modificat 03.04.2017
	    //document.location = "EditAngajat_Recrutori.aspx?id=" + obj.childNodes(1).innerText;
        
	    var x = obj.childNodes[2];
	    if (x.innerText !== undefined)
	    {
	        document.location = "EditAngajat_Recrutori.aspx?id=" + x.innerText;
	    }
		...
		<form id="Form1" method="post" runat="server">
			<table cellSpacing="0" cellPadding="0" width="100%" align="center" border="0">
				...
				<tr>
					<td align="center"><uc1:headermenu id="HeaderMenu1" runat="server" relativepath="../"></uc1:headermenu></td>
				</tr>
				<tr>
					<td align="center">
				...
				<TR>
					<TD align="center" height="50"><input class="ButtonStyle" id="btnInapoi" onmouseover="MouseOverButton(this)" onclick="document.location='Recrutori.aspx'"
