...
{
	/// <summary>
	/// Summary description for AdminPrimulAngajator.
	/// </summary>
	public class AdminPrimulAngajator : System.Web.UI.Page
	{
		#region Variabile
		...
		protected System.Web.UI.WebControls.DropDownList lstLuna;
		protected System.Web.UI.WebControls.DropDownList lstAn;
		...
		protected System.Web.UI.HtmlControls.HtmlInputHidden txtHiddenLuna;
		protected System.Web.UI.HtmlControls.HtmlInputHidden txtHiddenAn;
		...
		private void CreateVarJavaScript()
		{
			...
			Response.Write( "<script>var lstLuna = '"+lstLuna.ClientID+"'</script>" );
			Response.Write( "<script>var lstAn = '"+lstAn.ClientID+"'</script>" );
			Response.Write( "<script>var txtHiddenLuna = '"+txtHiddenLuna.ClientID+"'</script>" );
			Response.Write( "<script>var txtHiddenAn = '"+txtHiddenAn.ClientID+"'</script>" );
		...
		private void btnAddAngajator_Click(object sender, System.EventArgs e)
		{
			...
			try
			{
				...
				{
					int zi = 1;
					int luna = int.Parse(txtHiddenLuna.Value);
					int an = int.Parse(txtHiddenAn.Value);
					DateTime data = new DateTime(an, luna, zi);
					myAdmin.LunaActiva = data;
					angajatorId = myAdmin.InsertFirstAngajator();
				}
				else
				{
