<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AdminInvaliditati.ascx.cs" Inherits="SiemensHR.Administrare.AdminInvaliditati" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
<script>
function sp3FormIDfix()
{
document.forms[0].id=ctrlID + "_Form1";
document.getElementById(requiredDenumire).innerText = '';
document.getElementById(requiredCoeficient).innerText = '';
document.getElementById(regularDenumire).innerText = '';
document.getElementById(regularCoeficient).innerText = '';
...
function ShowAddForm()
{
	...
	eval(ctrlID + "_Form1." + ctrlID + "_txtCoeficient.value = '0';");	
...
{
	eval(ctrlID + "_Form1." + ctrlID + "_txtInvaliditateID.value = id;");
				...
				<table cellSpacing="1" cellPadding="0" border="0" id="Table2">
					<tr>
						<td class="BigBlueBold" id="tdTitle" runat="server" align="center" colSpan="2" height="50">
							Introduce invaliditate noua</td>
					</tr>
					<tr>
					...
					<tr>
						<td>
							<table class="tabBackground" cellSpacing="1" cellPadding="0" border="0" width="100%" id="Table3">
								<tr>
									...
									<td><asp:textbox id="txtDenumire" runat="server" MaxLength="100" CssClass="NormalEditBoxuri" size="50"
										...
										<asp:requiredfieldvalidator id="requiredDenumire" runat="server" ControlToValidate="txtDenumire" ErrorMessage="Completati denumirea invaliditatii!"
								...
								<tr>
									<td class="NormalGreenBold">Coeficient :</td>
									<td><asp:textbox id="txtCoeficient" runat="server" MaxLength="5" CssClass="NormalEditBoxuri" size="50"
											Width="300px"></asp:textbox><SPAN class="CommentRedBold">*</SPAN>
										<asp:requiredfieldvalidator id="requiredCoeficient" runat="server" ControlToValidate="txtCoeficient" ErrorMessage="Completati coeficientul invaliditatii!"
											CssClass="AlertRedBold"><</asp:requiredfieldvalidator>
										<asp:regularexpressionvalidator id="regularCoeficient" runat="server" CssClass="AlertRedBold" ControlToValidate="txtCoeficient"
											ErrorMessage="Campul necesita valoare numerica!" ValidationExpression="\d*\.?\d*">< Valoare numerica!</asp:regularexpressionvalidator>
									</td>
								</tr>
								<tr>
									<td class="GreenSeparator" colSpan="2"><IMG height="1" src="images/1x1.gif"></td>
								...
								<tr>
									...
									<td><asp:textbox id="txtDescriere" runat="server" MaxLength="100" CssClass="AreaStyle" TextMode="MultiLine"
											Rows="4" Columns="40" Width="300px"></asp:textbox>
							...
							<asp:TextBox id="txtInvaliditateID" runat="server"></asp:TextBox></td>
					</tr>
					<TR>
					...
					<tr id="td_addLine" runat="server">
						<td align="center" colSpan="2" height="50">
							<asp:button id="btnAdd" onmouseover="MouseOverButton(this)" onmouseout="MouseOutButton(this)"
								runat="server" CssClass="ButtonStyle" Text="Salveaza invaliditate"></asp:button>&nbsp;
					...
					<tr id="td_editLine" runat="server">
						<td align="center" colSpan="2" height="50">
							<asp:button id="btnModify" onmouseover="MouseOverButton(this)" onmouseout="MouseOutButton(this)"
								runat="server" CssClass="ButtonStyle" Text="Modifica invaliditate"></asp:button>&nbsp;
							<asp:button id="btnDelete" onmouseover="MouseOverButton(this)" onmouseout="MouseOutButton(this)"
								runat="server" CssClass="ButtonStyle" Text="Sterge invaliditate" CausesValidation="False"></asp:button>&nbsp;
		...
		<tr id="add_buttonLine" runat="server" height="50">
			<td align="center">
				<table cellSpacing="0" cellPadding="0" border="0" id="Table4">
					<tr>
						<td class="UnderlineBlackBold">Pentru adaugarea unei invaliditati noi apasati pe 
							acest buton:
						</td>
						<td>&nbsp;<INPUT class="ButtonStyle" onmouseover="MouseOverButton(this)" onclick="ShowAddForm()"
								onmouseout="MouseOutButton(this)" type="button" value="Invaliditate noua">&nbsp;</td>
					</tr>
				</table>
			</td>
		</tr>
